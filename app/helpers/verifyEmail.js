...
const emailVerification = async (email,html)=> {
...
const getTemplateVerification = (token) => {
    return `
    <head>
    ...
    <div class="email_content">
        ...
        <h2>Hola bienvenido a PatagonianStyles, tu tienda de zapatillas online.</h2>
        <p>Podras comprar las zapatillas de la mejor calidad al mejor precio, IMPORTADAS DE BRASIL</p>
        <p>Para confirmar tu correo porfavor hace click en el siguiente link, si tu no has accedido ha nuestra pagina, ignora este mensaje!</p>
        <button  class="btnverification" type="button"><a class="link" style="color: #ffff;" href="http://localhost:3000/api/user/confirm/${token}">Confirmar Cuenta</a></button>
    </div>
    <div class="footer">
